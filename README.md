[![Release slidev](https://github.com/inusturbo/slidevs/actions/workflows/release.yaml/badge.svg)](https://github.com/inusturbo/slidevs/actions/workflows/release.yaml)
